    ...
    <div class=" back-img">
        ...
        <div class="text-center">
            <span class="official-color">Home <span class="ms-2 h-color">/</span></span><span
                class="official-color ms-2">Pages contact<span class="ms-2 h-color ">/</span> </span><span
    ...
    <div class=" container bg-light py-5 rounded mt-5 mb-5 col-xl-12">
        ...
        <form action="{{url('submitFormData')}}" class="px-3" method="POST">
            ...
            <div class="row px-5 ">
                <div class="col-xl-7">
                    <div class="py-2">
                        <input type="text" class="form-control py-3 rounded-3 " placeholder="Your name" name="name">
                    </div>
                    <div class="py-3">
                        <input type="text" class="form-control py-3 rounded " placeholder="Your Email" name="email">
                    </div>
                    <textarea name="message" id="msg" cols="74" rows="5" placeholder="Your Message"
